/* @ts-self-types="./lxmf_stamper_wasm.d.ts" */

export class StampSolver {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        StampSolverFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_stampsolver_free(ptr, 0);
    }
    /**
     ...
     */
    get attempts() {
        const ret = wasm.stampsolver_attempts(this.__wbg_ptr);
     ...
     * @param {number} cost
     * @param {number} expand_rounds
     */
    constructor(material, cost, expand_rounds) {
        const ptr0 = passArray8ToWasm0(material, wasm.__wbindgen_export3);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.stampsolver_new(ptr0, len0, cost, expand_rounds);
        this.__wbg_ptr = ret;
        StampSolverFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    solve_batch(iterations) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.stampsolver_solve_batch(retptr, this.__wbg_ptr, iterations);
...
if (Symbol.dispose) StampSolver.prototype[Symbol.dispose] = StampSolver.prototype.free;
 ...
 * @returns {boolean}
 */
export function verify_stamp(material, stamp, cost, expand_rounds) {
    const ptr0 = passArray8ToWasm0(material, wasm.__wbindgen_export3);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(stamp, wasm.__wbindgen_export3);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.verify_stamp(ptr0, len0, ptr1, len1, cost, expand_rounds);
    return ret !== 0;
}
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./lxmf_stamper_wasm_bg.js": import0,
    };
}

const StampSolverFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_stampsolver_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('lxmf_stamper_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
